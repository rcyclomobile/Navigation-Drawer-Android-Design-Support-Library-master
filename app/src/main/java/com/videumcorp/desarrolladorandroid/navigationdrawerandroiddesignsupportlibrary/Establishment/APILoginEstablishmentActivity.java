...
public class APILoginEstablishmentActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), APIRegisterEstablishmentActivity.class);
    ...
    public void enter(View view){
        ...
        if (cursor.moveToFirst()) {
            ...
            toast.show();
            Intent intent = new Intent(APILoginEstablishmentActivity.this, APIMainEstablishmentActivity.class);
            intent.putExtra(APIMainEstablishmentActivity.NAME, name);
            startActivity(intent);
        }
