...
import com.videumcorp.desarrolladorandroid.navigationdrawerandroiddesignsupportlibrary.Establishment.APIMainEstablishmentActivity;
import com.videumcorp.desarrolladorandroid.navigationdrawerandroiddesignsupportlibrary.R;
import com.videumcorp.desarrolladorandroid.navigationdrawerandroiddesignsupportlibrary.DataBase.RcycloDatabaseHelper;

import java.util.ArrayList;

public class APIMyAdapterEstablishment extends ArrayAdapter<Container> {

    private final Context context;
    private final ArrayList<Container> itemsArrayList;
    private SQLiteDatabase db;

    public APIMyAdapterEstablishment(Context context, ArrayList<Container> itemsArrayList) {
                ...
                builder.setMessage(
                        ...
                        builder.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                APIMainEstablishmentActivity activity = (APIMainEstablishmentActivity)context;
                                activity.finish();
