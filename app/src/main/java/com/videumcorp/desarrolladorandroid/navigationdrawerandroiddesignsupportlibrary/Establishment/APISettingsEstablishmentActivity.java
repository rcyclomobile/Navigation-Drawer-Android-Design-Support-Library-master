...
public class APISettingsEstablishmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        APISettingsEstablishmentActivity.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValueColorPrimaryDark, true);
    ...
    public void editar_perfil(View view){
        ...
        Intent intent = new Intent(this, APIEditProfileEstablishmentActivity.class);
        intent.putExtra(APIEditProfileEstablishmentActivity.NAME, empresa);
    ...
    public void editar_contraseña(View view){
        ...
        Intent intent = new Intent(this, APIChangePasswordEstablishmentActivity.class);
        intent.putExtra(APIChangePasswordEstablishmentActivity.NAME, empresa1);
        startActivity(intent);
        finish();
    }
    ...
    public void editar_telefono(View view){
        String empresa1 = (String)getIntent().getExtras().get(NAME);
        //cambiar
        Intent intent = new Intent(this, APIEditPhoneEstablishmentActivity.class);
        intent.putExtra(APIEditPhoneEstablishmentActivity.NAME, empresa1);
        startActivity(intent);
        finish();
    }
