...
import com.videumcorp.desarrolladorandroid.navigationdrawerandroiddesignsupportlibrary.Establishment.APIDeleteContainerEstablishmentActivity;
import com.videumcorp.desarrolladorandroid.navigationdrawerandroiddesignsupportlibrary.R;
import com.videumcorp.desarrolladorandroid.navigationdrawerandroiddesignsupportlibrary.DataBase.RcycloDatabaseHelper;

import java.util.ArrayList;

public class APIMyAdapterDeleteEstablishment extends ArrayAdapter<Container> {
    ...
    public APIMyAdapterDeleteEstablishment(Context context, ArrayList<Container> itemsArrayList) {
            ...
            public void onClick(final View v) {
                ...
                builder.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        APIDeleteContainerEstablishmentActivity activity = (APIDeleteContainerEstablishmentActivity) context;
                        activity.finish();
