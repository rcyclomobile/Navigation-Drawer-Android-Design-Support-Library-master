...
import com.videumcorp.desarrolladorandroid.navigationdrawerandroiddesignsupportlibrary.MyAdapter.APIWaitAdapter;
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("success")) {
                if (arrayList.isEmpty()) {
                    ...
                    APIWaitAdapter adapter = new APIWaitAdapter(WaitCont.this, arrayList);
