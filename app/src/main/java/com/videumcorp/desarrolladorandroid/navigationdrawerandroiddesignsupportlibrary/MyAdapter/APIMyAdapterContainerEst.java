    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        btCambiarDireccion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                intent.putExtra(NewDirection.NAME,fundacion);
                intent.putExtra(NewDirection.CONTAINER,nombre);
                intent.putExtra(NewDirection.LATLONG, coordenadas);
                intent.putExtra(NewDirection.COMPANY, empresa);
