...
public class APIRegisterCompanyActivity extends AppCompatActivity {
            ...
            if (isEmailValid(email)) {
                ...
                if( isEmailUsed(email)){
                    ...
                    TimerTask task = new TimerTask() {
                        @Override
                        public void run() {
                            Intent intent = new Intent().setClass(APIRegisterCompanyActivity.this, APILoginCompanyActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
