...
public class APIRegisterEstablishmentActivity extends AppCompatActivity {
            ...
            if (isEmailValid(email)) {
                ...
                if( isEmailUsed(email)){
                    ...
                    TimerTask task = new TimerTask() {
                        @Override
                        public void run() {
                            Intent intent = new Intent().setClass(APIRegisterEstablishmentActivity.this, APILoginEstablishmentActivity.class);
