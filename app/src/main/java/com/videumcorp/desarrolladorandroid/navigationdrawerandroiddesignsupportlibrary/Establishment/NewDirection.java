...
public class NewDirection extends AppCompatActivity {
            ...
            if (addressList.isEmpty()) {
                ...
                mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
                    ...
                    public boolean onMarkerClick(com.google.android.gms.maps.model.Marker marker) {
                        ...
                        final LayoutInflater inflater = (LayoutInflater) NewDirection.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

                        final View dialoglayout = inflater.inflate(R.layout.modify_adress_container, null);

                        AlertDialog.Builder builder = new AlertDialog.Builder(NewDirection.this);
                        ...
                        builder.setPositiveButton("Cambiar", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                SQLiteOpenHelper rcycloDatabaseHelper = new RcycloDatabaseHelper(NewDirection.this);
                                ...
                                Toast.makeText(getApplicationContext(), "La direccion del contenedor ha sido cambiada.",
                                        Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(NewDirection.this, APIAvailableContainer.class);
                                intent.putExtra(APIAvailableContainer.NAME, fundacion);
