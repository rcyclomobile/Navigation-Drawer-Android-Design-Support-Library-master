...
public class APIChangePasswordCompanyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        APIChangePasswordCompanyActivity.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValueColorPrimaryDark, true);
    ...
    public void change_password(View view) {
        ...
        if(passwordCo1.matches("")){
            ...
            Intent intent = new Intent(this, APISettingsCompanyActivity.class);
