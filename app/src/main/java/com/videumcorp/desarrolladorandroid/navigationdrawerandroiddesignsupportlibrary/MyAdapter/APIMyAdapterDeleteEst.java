...
import com.videumcorp.desarrolladorandroid.navigationdrawerandroiddesignsupportlibrary.Establishment.APIDeleteContainer;
import com.videumcorp.desarrolladorandroid.navigationdrawerandroiddesignsupportlibrary.R;
import com.videumcorp.desarrolladorandroid.navigationdrawerandroiddesignsupportlibrary.DataBase.RcycloDatabaseHelper;

import java.util.ArrayList;

public class APIMyAdapterDeleteEst extends ArrayAdapter<Container> {
    ...
    public APIMyAdapterDeleteEst(Context context, ArrayList<Container> itemsArrayList) {
            ...
            public void onClick(final View v) {
                ...
                builder.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        APIDeleteContainer activity = (APIDeleteContainer) context;
                        activity.finish();
