...
public class APIModifyContainerCompanyActivity extends Activity {
    ...
    public void actualizar(View view){
        ...
        Intent intent = new Intent(this, APIMainCompanyActivity.class);
        intent.putExtra(APIMainCompanyActivity.EMPRESA, nameCompany);
